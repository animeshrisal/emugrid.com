...
emcc -O3 -s WASM=1 -s EXPORTED_RUNTIME_METHODS='["cwrap"]' -s -s ALLOW_MEMORY_GROWTH=1 -s SINGLE_FILE=1 -s MODULARIZE=1 -s 'EXPORTED_FUNCTIONS=["_fib", "_test"]' -s "ENVIRONMENT='web'" -o ./main.js *.cpp
